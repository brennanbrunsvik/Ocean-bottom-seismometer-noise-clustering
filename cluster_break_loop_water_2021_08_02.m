...
dataSets = struct('data1', OthVarMat(1,:), 'data2', string(cats(8).data), 'data3', string(cats(10).data)); 
...
splits = [2, 3, 2]; if levels_break <3; splits(3) = 0; end

loopOptimizePenalty = [ true false false ] ; 
